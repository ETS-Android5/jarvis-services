...
public class ApplicationHealthActivity extends Activity
{
	...
	public void ForcePersistentComponentsIntegrity() {
		...
		pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.auth.AccountPickerActivity.class), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
		...
		pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.auth.VerifyAccountActivity.class), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
		pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.auth.AccountSettings.class), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
		...
		pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.ServiceSettingActivity.class), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
