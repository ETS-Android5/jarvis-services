...
public class CoreServiceSettingsActivity extends Activity
{
	@Override
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		desc.setText("Служба Jarvis Core Init - основной процесс системы Jarvis, который обеспечивает работу Сервисов Jarvis. Если ее остановить, то приложения могут работать неправильно. Также будет отключена синхронизация. Доступ к Jarvis Engine будет закрыт");
		statement();
	}
	...
	void toast(final CharSequence text)
	{
        mHandler.post(new Runnable()
		{
			...
			{
				Toast.makeText(com.teslasoft.jarvis.core.CoreServiceSettingsActivity.this, text, Toast.LENGTH_SHORT).show();
			}
		});
    }
