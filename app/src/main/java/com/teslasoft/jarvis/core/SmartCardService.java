	...
	public void start(Context context)
	{
		...
		if (android.os.Build.VERSION.SDK_INT >= 21)
		{
			if (android.os.Build.VERSION.SDK_INT >= 26)
			{
				...
				int notifyID = 2; 
				String CHANNEL_ID = "SmartCardServer"; // The id of the channel. 
					...
					timer.scheduleAtFixedRate(new TimerTask()
						{
							...
							public void run()
							{
								...
								if (pm.getComponentEnabledSetting(new ComponentName(com.teslasoft.jarvis.core.SmartCardService.this, com.teslasoft.jarvis.core.DataProtectorService.class)) == 1)
								{
									...
									{
										try {
											startService(new Intent(com.teslasoft.jarvis.core.SmartCardService.this, com.teslasoft.jarvis.core.DataProtectorService.class));
										}
										catch (Exception e)
										{
