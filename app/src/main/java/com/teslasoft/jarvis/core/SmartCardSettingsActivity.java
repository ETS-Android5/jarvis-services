...
public class SmartCardSettingsActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		desc.setText("Служба Teslasoft SmartCard отвечает за работу аутентификации с помощью смарт-карт. Если ее остановить или отключить вход с помощью смарт-карт может стать недоступен.");
		statement();
	}
    ...
    mHandler.post(new Runnable()
		{
			...
			{
				Toast.makeText(com.teslasoft.jarvis.core.SmartCardSettingsActivity.this, text, Toast.LENGTH_SHORT).show();
			}
		});
    }
	...
	public void Disable(View v)
	{
		...
		if (pm.getComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.SmartCardService.class)) == 1)
		{
			stopService(new Intent(this, com.teslasoft.jarvis.core.SmartCardService.class));
			pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.SmartCardService.class),
	...
	public void StopTask(View v)
	{
		...
		{
			startService(new Intent(this, com.teslasoft.jarvis.core.SmartCardService.class));
			/*estate.setText("Disable");
			 state.setText("State: Running");
			 cstate.setText("Force stop");
			 cstate.setTextColor(0xFFFF3D00);*/
