...
public class DPSSettingsActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		desc.setText("Служба Data Protector Service отвечает за защиту пользовательских данных. Если остановить/отключить эту службу, то все пользовательские данные, связанные с Системой Jarvis могут быть удалены");
	...
	void toast(final CharSequence text)
	{
        mHandler.post(new Runnable()
		{
			...
			{
				Toast.makeText(com.teslasoft.jarvis.core.DPSSettingsActivity.this, text, Toast.LENGTH_SHORT).show();
			}
		});
    }
	...
	public void Disable(View v)
	{
		...
		if (pm.getComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.DataProtectorService.class)) == 1)
		{
			...
			pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.DataProtectorService.class),
