...
public class LCSSettingsActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		desc.setText("Служба Licence Check Service проверяет наличие лицензии на программное обеспечение Jarvis. Она запускается соответствующим приложением. Если ее отключить, то некоторые приложения могут работать неправильно");
	...
	void toast(final CharSequence text)
	{
        mHandler.post(new Runnable()
		{
			...
			{
				Toast.makeText(com.teslasoft.jarvis.core.LCSSettingsActivity.this, text, Toast.LENGTH_SHORT).show();
			}
		});
    }
	...
	public void Disable(View v)
	{
		...
		if (pm.getComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.LicenceCheckService.class)) == 1)
		{
			stopService(new Intent(this, com.teslasoft.jarvis.core.LicenceCheckService.class));
			pm.setComponentEnabledSetting(new ComponentName(this, com.teslasoft.jarvis.core.LicenceCheckService.class),
	...
	public void StopTask(View v)
	{
		...
		{
			startService(new Intent(this, com.teslasoft.jarvis.core.LicenceCheckService.class));
