...
public class LinuxPlatLogo extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.tux_plat_logo);
		...
		button.setOnLongClickListener(new View.OnLongClickListener()
		{
			@Override public boolean onLongClick(View v)
			{
				...
				if (ii >= 5)
				{
					/*ShowVersion(com.teslasoft.jarvis.easter.LinuxPlatLogo.this);
	...
	public void ShowVersion(Context context)
	{
		try {
			...
			showToast(LinuxPlatLogo.this, "💎 Jarvis Services " + vs + " 💎");
		}
