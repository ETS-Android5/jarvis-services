...
public class OPlatLogo extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.oreo_plat_logo);
		...
		button.setOnLongClickListener(new View.OnLongClickListener()
		{
			@Override public boolean onLongClick(View v)
			{
				...
				if (ii >= 5)
				{
						/*ShowVersion(com.teslasoft.jarvis.easter.NekoPlatLogo.this);
						 Intent intent = new Intent(LinuxPlatLogo.this, EasterEgg.class);
	...
	public void ShowVersion(Context context)
	{
		try {
			...
			showToast(OPlatLogo.this, "💎 Jarvis Services " + vs + " 💎");
		}
